...
void RDCMessage::appendString(const QString &data)
{
...
const unsigned char *RDCMessage::nextData(int len)
{
    SAFE_DELETE(this->m_pPartialData);
...
void RDCMessage::setServiceCommand(ServiceCommand cmd)
{
    return this->appendInteger(cmd);
}
